"""
report-repair.rb: from input.text find the two entries that sum to 2020 and then multiply those two numbers together; solve puzzle at https://adventofcode.com/2020/day/1
1 December 2020
@Vicki_Langer
"""
